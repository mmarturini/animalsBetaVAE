...
dog_labels = []
label_map = {1:"Dog"}
for path in glob('/u/dssc/mmarturi/Deep_Learning/AnimalsBetaVAE/animalsBetaVAE/afhq/train/dog/*') + glob('/u/dssc/mmarturi/Deep_Learning/AnimalsBetaVAE/animalsBetaVAE/afhq/val/dog/*'):
    dog_paths.append(path)
    dog_labels.append(1)

dataset = AnimalDataset(dog_paths, dog_labels, (250,250))
BATCH_SIZE = 128
...
torch.save(vae.state_dict(), "dogVAEb120.pt")
